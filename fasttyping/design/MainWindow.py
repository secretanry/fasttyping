...
from fasttyping.scripts.text_generator import generate_text
import time
...
class MainWindow(QWidget):
    ...
    def setup_ui(self, stacked_widget: QStackedWidget):
        ...
        self.start_again_btn.setGeometry(QtCore.QRect(550, 530, 161, 51))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(12)
    ...
    def retranslate_ui(self, main_window):
        ...
        self.start_again_btn.setText(_translate("MainWindow", "Start"))
